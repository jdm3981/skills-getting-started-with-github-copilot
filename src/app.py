...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practice and match play for soccer enthusiasts",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["noah@mergington.edu", "ava@mergington.edu"]
    },
    "Yoga Club": {
        "description": "Relaxation, flexibility, and strength training with yoga",
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and performance practice",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["charlotte@mergington.edu", "henry@mergington.edu"]
    },
    "Debate Team": {
        "description": "Research, arguments, and public speaking competitions",
